...
data = dict(
    ...
    train=dict(
        ...
        ann_file=(
            ...
            '/data/xzr/Datas/cityscapes_series/cityscapes_foggy/annotations/train_all_beta_0.01.json',
            '/data/xzr/Datas/cityscapes_series/cityscapes_rain/annotations//train/alpha_0.01_beta_0.005_dropsize_0.01_pattern_1_all.json'
                  ),
        img_prefix='/data/xzr/Datas/cityscapes_series/cityscapes_series_Images',
        pipeline=[
            dict(type='LoadImageFromFile',target=2),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=[(1200,600), (1600,800)], multiscale_mode='range', keep_ratio=True),
    ...
    val=dict(
        ...
        # ann_file='/data/xzr/Datas/cityscapes_series/cityscapes_foggy/val_all_beta_0.01.json',
        ann_file='/data/xzr/Datas/cityscapes_series/cityscapes_rain/annotations/val/alpha_0.01_beta_0.005_dropsize_0.01_pattern_1_all.json',
        img_prefix='/data/xzr/Datas/cityscapes_series/cityscapes_series_Images',
        pipeline=[
    ...
    test=dict(
        ...
        classes=classes,
        # ann_file='/data/xzr/Datas/cityscapes_series/cityscapes/annotations/val_all.json',
        # ann_file='/data/xzr/Datas/cityscapes_series/cityscapes_foggy/annotations/val_all_beta_0.01.json',
