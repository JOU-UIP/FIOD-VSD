...
from .da_head import DAHead,Mult_DAHead
from .da_head_vgg import DAHead_VGG,Mult_DAHead_VGG
...
__all__ = [
    ...
    'AscendRetinaHead', 'AscendSSDHead','DAHead','Mult_DAHead','DAHead_VGG',"Mult_DAHead_VGG"
]
