...
class DAPerHead(nn.Module):
    ...
    def __init__(self, in_channels, domain_num_classes):
        ...
        self.conv2_da = nn.Conv2d(256, domain_num_classes, kernel_size=1, stride=1)
    ...
    def forward(self, x):
        ...
        feature=self.conv2_da(t)
        return feature

@HEADS.register_module()
class DAHead_VGG(torch.nn.Module):

    def __init__(self,domain_num_classes,in_channels=256):
        super(DAHead_VGG, self).__init__()
        ...
        self.consist_arch_settings =[3,2,1,1]
...
@HEADS.register_module()
class  Mult_DAHead_VGG(torch.nn.Module):

    def __init__(self,domain_num_classes,in_channels=256):
        super( Mult_DAHead_VGG, self).__init__()
